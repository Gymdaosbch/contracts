...
contract Distributor is Ownable {
    ...
    uint32 public nextEpochBarbell;
    ...
    constructor( address _treasury, address _Barbell, uint32 _epochLength, uint32 _nextEpochTime ) {        
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return Barbell.totalSupply().mul( _rate ).div( 1000000 );
    }
