...
contract Muscle is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Muscle", "MUSCLE", 9) ERC20Permit() {
    ...
    /**
        @notice increases Muscle supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Muscle
