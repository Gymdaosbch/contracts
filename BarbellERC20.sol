...
contract Barbell is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Barbell", "BRB", 9) ERC20Permit() {
    ...
    /**
        @notice increases Barbell supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Barbell
