...
contract MuscleBondDepository is Ownable {
    ...
    /* ======== STATE VARIABLES ======== */
    IERC20 public immutable MUSCLE; // token given as payment for bond
    IWBCH public immutable principle; // token used to create bond
    ITreasury public immutable treasury; // mints MUSCLE when receives principle
    ...
    uint32 public lastDecay; // reference MUSCLE for debt decay
    ...
    struct Bond {
        uint payout; // MUSCLE remaining to be paid
